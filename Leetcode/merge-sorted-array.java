// @leetup=custom
// @leetup=info id=88 lang=java slug=merge-sorted-array
...
* The result of the merge is [1,2,2,3,5,6] with the underlined elements coming fro
* m nums1.
* 
* Example 2:
* 
    ...
    public void merge(int[] nums1, int m, int[] nums2, int n) {
        ...
        while (i1 < m && i2 < n) {
            if (nums1[i1] < nums2[i2]) {
                resultant[i] = nums1[i1];
                i1++;
            } else {
                resultant[i] = nums2[i2];
                i2++;
            }
